  ...
  async function handleAdd() {
    ...
    try {
      await createMvt.mutateAsync({
        ...
        date: form.date,
        typeOp: form.typeOp,
        quantite: parseNumber(form.quantiteStr),
        motif: form.motif,
      });
  ...
  async function handleSaveConfig(ing: Ingredient) {
    ...
    try {
      await updateIng.mutateAsync({
        ...ing,
        stockInitial: parseNumber(cfg.stockStr),
        seuilSecurite: parseNumber(cfg.seuilStr),
      });
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base">
              Configuration — seuils et stocks initiaux
            </CardTitle>
            <p className="text-sm text-muted-foreground">
              Modifiez le stock initial et le seuil d'alerte par ingrédient.
            </p>
          </CardHeader>
          <CardContent>
            <Table>
                        ...
                        <Badge
                          className={
                            m.typeOp === "Entrée"
                              ...
                              : "bg-red-900/40 text-red-300 hover:bg-red-900/40"
                          }
                        >
                          {m.typeOp}
                        </Badge>
